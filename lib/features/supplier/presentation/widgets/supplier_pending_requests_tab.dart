...
/// Tab for Pending Requests: list or empty state.
class SupplierPendingRequestsTab extends StatelessWidget {
  const SupplierPendingRequestsTab({super.key});

  @override
  Widget build(BuildContext context) {
    return const TabPageWrapper(
      title: 'Pending Requests',
      child: SupplierPendingRequestsBody(),
    );
  }
}

class SupplierPendingRequestsBody extends StatelessWidget {
  const SupplierPendingRequestsBody({super.key});
