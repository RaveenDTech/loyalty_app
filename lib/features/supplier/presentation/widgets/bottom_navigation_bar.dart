...
class CenterQRButton extends StatefulWidget {
  final VoidCallback onTap;

  const CenterQRButton({
    super.key,
    required this.onTap,
  });

  @override
  State<CenterQRButton> createState() => _CenterQRButtonState();
}

class _CenterQRButtonState extends State<CenterQRButton>
